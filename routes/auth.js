    ...
    if (userInDB) {
      ...
      const mailOptions = {
        ...
        *[class*="mobile-only"], div.mobile-only { display: block !important; max-height: none !important; }
        ...
        <!-- ///// Image ///// -->
        <tr>
        <td><a href="{{mycheckExperienceUrl}}" target="_blank" style="text-decoration:none;"><img src="https://res.cloudinary.com/duw4zfhmh/image/upload/v1680689442/at_mine/atmineheader_fmjjw8.png" width="600" alt="image_description" border="0" style="display:block;" class="width100 heightAuto"></a></td>
        </tr>
        <!-- ///// Image END ///// -->
        <tr>
        ...
        <!-- ///// Text ///// -->
        <tr>
        <td align="justify" style="padding-bottom:15px; line-height:18px; font-size:15px; font-family:arial, helvetica, sans-serif; color:#444444;">Hello ${username},<br><br>Welcome to AtMine, the app that lets you rent out your unused spaces and discover unique and affordable spaces to rent.<br><br>With AtMine, you can easily list and rent out a variety of spaces, including parking spots, gardens, BBQ areas, and more. Whether you want to monetize your underused assets or find a perfect spot for your next gathering, AtMine makes it simple and secure.
        </td>
        ...
        <!-- ///// Text ///// -->
        <tr>
        <td align="justify" style="padding-bottom:15px; line-height:18px; font-size:15px; font-family:arial, helvetica, sans-serif; color:#444444;">Our platform provides you with everything you need to get started, from a user-friendly interface to powerful tools that help you manage your listings, bookings, and payments. Plus, with our extensive community of renters and hosts, you'll have access to a wide range of options and opportunities.<br><br>Thank you for choosing AtMine. We're excited to have you on board and look forward to helping you unlock the potential of your spaces.<br><br>The AtMine Team
        </td>
        </tr><table border="0" cellspacing="0" cellpadding="0" width="100%">
        </table>
        <!-- ///// Text END ///// -->
        ...
        <!-- ///// Text END ///// --><!-- ///// Email address ///// --><strong style="font-size:14px;"><a href="{{email}} " style="color:#ffffff; text-decoration:none;">${email}</a></strong><!-- ///// Email address END ///// --></td>
        </tr>
        <!-- ///// Title END ///// -->
